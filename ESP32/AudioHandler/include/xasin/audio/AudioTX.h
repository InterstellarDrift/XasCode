...
#define CONFIG_XASAUDIO_TX_SAMPLERATE 48000
#define CONFIG_XASAUDIO_TX_FRAMELENGTH 20
#define CONFIG_XASAUDIO_TX_DMA_COUNT 2
#define CONFIG_XASAUDIO_TX_STREAM_MAX_BITRATE 24000
#define CONFIG_XASAUDIO_TX_STREAM_BUFFER_LENGTH 1000
